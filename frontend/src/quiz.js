...
function Quiz() {
  ...
  return (
    ...
    <label htmlFor="enjoy">I enjoy working on more than one project at a time.</label>
      <input {...register("enjoy", { required: true })} type="radio" value="completely-disagree" id="1" />
      <input {...register("enjoy", { required: true })} type="radio" value="I-disagre" id="2"/>
      <input {...register("enjoy", { required: true })} type="radio" value="I-agree" id="3"/>
      <input {...register("enjoy", { required: true })} type="radio" value="completely-agree" id="4"/>
    </div>
    <div className="radioContainer">
