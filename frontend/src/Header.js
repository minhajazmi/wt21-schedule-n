...
const [secondPopup, setSecondPopup] = useState(false);
    return (
        <div className="header">
            ...
            <div className="headerItem1">
                <h1 onClick={() => setFirstPopup(true)}>What is a time management style?</h1>
            </div>
            <div className="headerItem1">
                <h1 onClick={() => setSecondPopup(true)}>How does it work?</h1></div>
            ...
            <div><h2>What is a time management style?</h2>
<p>Your time management style is a way of describing how you plan and organise your tasks, in order to be most productive. Everyone is different, and so there's no one piece of advice that works for everyone when it comes to managing your time more efficiently.
</p><p>Which is why we at Schedule N believe the first step in improving your time management style is knowing what it is.</p>
